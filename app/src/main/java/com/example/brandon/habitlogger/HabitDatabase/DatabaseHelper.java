...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // CREATE TABLE HABITS_TABLE (ID INTEGER PRIMARY KEY, NAME TEXT NOT NULL, DESCRIPTION TEXT, CATEGORY INTEGER NOT NULL, ICON_RES_ID TEXT)
    ...
    // CREATE TABLE ENTRIES_TABLE (ID INTEGER PRIMARY KEY, HABIT_ID INTEGER NOT NULL, START_TIME INTEGER NOT NULL, DURATION INTEGER NOT NULL, NOTE TEXT)
